...
def lcd_byte(bits, mode,lcd_background):
  # Send byte to data pins
  # bits = the data
  # mode = 1 for data
  #        0 for command

  bits_high = mode | (bits & 0xF0) | lcd_background
  bits_low = mode | ((bits<<4) & 0xF0) | lcd_background
...
def off(): 
  lcd_byte(LCD_LINE_1, LCD_CMD,LCD_BACKLIGHT)
  lcd_byte(LCD_LINE_2, LCD_CMD,LCD_BACKLIGHT)
